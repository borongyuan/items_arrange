...
int main()
{
	char *fname = "C:\\Users\\EEG\\Desktop\\android_trackgyro_liusong_149_20170808_091345.csv"; //the address of test_File 
	...
	for(index = 0; index <100; index++)
	{
	 ...
	 {
		gx[num_index-25*index] = raw[6*num_index+3]; 
		gy[num_index-25*index] = raw[6*num_index+4];
		gz[num_index-25*index] = raw[6*num_index+5];
	 }
